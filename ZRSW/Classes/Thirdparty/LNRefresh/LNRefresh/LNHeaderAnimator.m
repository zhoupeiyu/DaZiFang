...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.text =  LNRefreshPullToRefresh;
    }
    return _titleLabel;
}
        ...
        case LNRefreshHeaderType_NOR: {
            switch (state) {
                ...
                case LNRefreshState_WillRefresh: {
                    self.titleLabel.text = LNRefreshReleaseToRefresh;
                ...
                case LNRefreshState_NoMoreData:
                    self.titleLabel.text =  LNRefreshNoMoreData;
                    break;
            }
        }
            break;
...
- (void)startRefreshAnimation_NOR {
    ...
    self.titleLabel.text =  LNRefreshLoading;
    self.imageView.transform = CGAffineTransformRotate(self.imageView.transform, M_PI);
}
...
- (void)endRefreshAnimation_NOR {
    ...
    self.titleLabel.text =  LNRefreshPullToRefresh;
