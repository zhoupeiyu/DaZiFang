...
#define LNRefreshLoading @""
#define LNRefreshPullToRefresh @"下拉刷新"
#define LNRefreshReleaseToRefresh @"释放刷新"
#define LNRefreshLoadingMore @"加载更多"
#define LNRefreshNoMoreData @"已经打破砂锅问到底啦~"
