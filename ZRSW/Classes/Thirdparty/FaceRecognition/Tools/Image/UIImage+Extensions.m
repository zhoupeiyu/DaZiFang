...
CGFloat HDegreesToRadians(CGFloat degrees);
CGFloat HRadiansToDegrees(CGFloat radians);
...
CGFloat HDegreesToRadians(CGFloat degrees) {return degrees * M_PI / 180;};
CGFloat HRadiansToDegrees(CGFloat radians) {return radians * 180/M_PI;};
...
{
    return [self imageRotatedByDegrees:HRadiansToDegrees(radians)];
}
...
- (UIImage *)imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(HDegreesToRadians(degrees));
    ...
    CGContextRotateCTM(bitmap, HDegreesToRadians(degrees));
