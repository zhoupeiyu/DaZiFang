...
- (void)refreshScrollViewContentSize {
    if (_allowCrop) {
//        if (_imageContainerView.tz_height < self.cropRect.size.height) {
//            self.imagePicVC.circleCropRadius = _imageContainerView.tz_height;
//            [self.previewVC configCropView];
//            return;
//        }
//        if (_imageContainerView.tz_width < self.cropRect.size.width) {
//            self.imagePicVC.circleCropRadius = _imageContainerView.tz_width;
//            [self.previewVC configCropView];
//            return;
//        }
